...
export default function Calculadora() {
    ...
    const eliminarItem = () => {
        /**
         * slice: te manda una parte de la cadena "Ho"
    ...
    const calcular = () => {
         ...
         * eval() => evalua una cadena de numeros y si hay un operador hace la operacion
        */
        try{
    ...
    return (
        <div className='contenedor'>
            <div className='calculadora'>
                <input id='texto' type="text" value={resultado} disabled/>
                <div>
